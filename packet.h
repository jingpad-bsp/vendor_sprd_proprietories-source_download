...
extern int send_data_message(int fd, unsigned char *buffer, int data_size, int flag,
                             int image_size, int image_fd);
extern int send_exec_message(int fd, unsigned long addr, int flag);
extern int send_dump_mem_message(int fd, unsigned int size, unsigned long addr,
                                 int flag);
...
unsigned short calculate_crc(unsigned short crc, unsigned char const *buffer, int len);
